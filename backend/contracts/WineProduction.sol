...
contract WineProduction {
    ...
    function creaLotto(
        ...
        // inizializza array e salva fase 0
    ...
    // ===================== CERCA LOTTO =====================
    function getLotto(uint256 _index)
        public
        view
        returns (
            uint256 id,
    ...
    function avanzaStato(uint256 _index, string memory _luogo) public {
        ...
        // aggiunge timestamp e luogo della fase
        lotto.timestamps.push(block.timestamp);
        lotto.luoghi.push(_luogo);
    }

    // ===================== FUNZIONI PER LEGGERE TIMESTAMPS E LUOGHI =====================
